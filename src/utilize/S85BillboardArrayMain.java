...
public class S85BillboardArrayMain {
    public static void main(String[] args) {
        ArrayList<S83Billboard> bills = new ArrayList<>(); //ArrayList를 생성한다. ArrayListdp Billboard 객체만 저장하기 위해 <Billboard>(제네릭)으로 제한한다.
        bills.add(new S83Billboard(1,"Cateen", 1,//1등의 정보를 저장한 Billboard 객체를 저장
                "https://www.billboard.com/images/pref_images/q61808osztw.jpg", "yula"));
        bills.add(new S83Billboard(2,
                "My", 2, "https://www.billboard.com/images/pref_images/q61808osztr.jpg", "yula"));
        bills.add(new S83Billboard(3,
        ...
        System.out.println("-----------------");
        for(S83Billboard bb : bills){ //ArrayList에 저장된 Billboard 객체를 향상된 for을 이용해서 출력한다.
            showAbout(bb);
        }
    }
