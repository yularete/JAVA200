...
public class S83BillboardMain2 {
    public static void main(String[] args) {
        ...
        S83Billboard b1 = new S83Billboard(1, "Cateen",1,"https://www.billboard.com/images/pref_images/q61808osztw.jpg","yula");
        //객체 출력
        showAbout(b1); // 빌보드 객체의 정보를 출력한다.
        //객체로 전달
        S83Billboard b = b1; //주소 복사한 후 주소의 객체 정보를 출력한다.
        showAbout(b); //객체 내용을 출력
    }
    public static void showAbout(S83Billboard bb){ //객체를 전달하여 출력...
